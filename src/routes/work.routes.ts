...
workRoutes.post('/work', registerWorkController.handle);
workRoutes.get('/work/:id', getWorkByIdController.handle);
workRoutes.put('/work/:id', updateWorkController.handle);
